...
const createComment = asyncHandler(async (req, res) => {
    ...
    return res.status(200).send({ message: 'Comment ' + newCommentCount + ' posted successfully' })
})

export { getAllReviews, createReview, getReview, editReview, deleteReview, createComment }